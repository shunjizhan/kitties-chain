...
impl pallet_kitties::Config for Runtime {
	...
	type KittyPrice = KittyPrice;		// use pre-defined KittyPrice from parameter_types!
	type PalletId = KittyPalletId;	// use pre-defined KittyPalletId from parameter_types!
}
